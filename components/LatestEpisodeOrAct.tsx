...
import style from "@/components/LatestEpisodeOrAct.module.css";
...
export default function LatestEpisodeOrAct() {
  ...
  return (
    <div className={style["self"]}>
      ...
      {actData.isLoading ? <Skeleton /> : null}
      {actData.error ? <Error error={actData.error} /> : null}
      {actData.data ? (
...
function Layout(props: { data: ValorantOfficialWeb.LatestEpisodeOrAct }) {
  return (
    <div className={style["banner"]}>
      <div className={style["background"]}>
        <img src={props.data?.background.url ?? ""} alt="banner background image" />
      </div>
